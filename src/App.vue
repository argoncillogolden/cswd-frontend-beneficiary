...
export default {
  ...
  beforeMount() {
    echo.leave('arrived-cash-channel');
  },
    ...
    async updateMe() {
      try {
        ...
        if (!response || response.status !== true) {
          ...
          this.address_line2 = this.benefeciary_info.address_line2;
          this.category_id = this.benefeciary_info.category_id;
        }
      } catch (error) {
        console.error(error);
      }
      ...
      echo.channel('arrived-cash-channel')
        .listen('CashArrived', (e) => {
          console.log(e);
          if (this.address_line2 === e.addressLine2 && this.category_id === e.categoryID) {
